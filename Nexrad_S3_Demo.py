    ...
    for dt in rrule.rrule(rrule.HOURLY, dtstart=start_date, until=end_date):
        ...
        for obj in radar_object1:
           ...
           for metvar in metvars:
                ...
                ax1.set_title('Pulse Precipitation',fontsize=40)
                ...
                ax = fig.add_subplot(2,2,3,projection=usemap_proj)
                ax.axis('off')
                ...
                # i=i+1
                ax.set_title('Radar Data on '+ savestr.split("_")[0][4:7]+"-"+savestr.split("_")[0][8:9]+"-"+savestr.split("_")[0][10:]+ " " +savestr.split("_")[1][0:2]+":"+savestr.split("_")[1][2:4], fontsize=40)
                plt.tight_layout()
               # plt.show()
               # return(fig)
                ...
                ax2 = fig.add_subplot(2,2,4,projection=usemap_proj)
                ax2.set_global()
                ...
                ax2.plot(360+rLON,rLAT,marker='o', color='red', markersize=15, transform=ccrs.PlateCarree())
                ...
                cbar.ax.tick_params(labelsize=20)
                ax2.set_title(figtitle,fontsize=40)
                fig.tight_layout()
                plt.show()
                fig.savefig(outdir+metvar+"_"+savestr+".png")
