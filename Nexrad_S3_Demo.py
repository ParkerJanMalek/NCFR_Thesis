...
#{radarsite}{year}{month}{date}_{hour}{minute}{second}_V06
i = 1
for obj in bucket.objects.filter(Prefix='2017/02/07/KBBX/KBBX20170207'):
    print(obj.key)
    ...
    plt.suptitle(savestr[0:3]+' Level 2 Data '+ savestr.split("_")[0][4:]+"_"+savestr.split("_")[1], fontsize=20)
    plt.tight_layout()
    plt.show()
